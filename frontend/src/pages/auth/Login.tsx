  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-white flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <p className="text-gray-400 text-center mb-8">Your safety is our priority</p>
        ...
        <p className="mt-8 text-center text-gray-400">
          Don't have an account? <Link to="/signup" className="text-pink-500 font-bold">Sign Up</Link>
        </p>
      </motion.div>
    </div>
  );
